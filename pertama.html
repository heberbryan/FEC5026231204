...
<html>
    ...
    <body>
        ...
        <h2 style="color: #2c3e50;">Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam
        </h2>
        <h6>Oleh : itsash <i>|</i> 18 <i>|</i> Source : ITS Online
        </h6>
        <img src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_084851-768x432.jpg" width=1000px >

        <br>
        <p>Suasana Kuliah Umum Mentoring Agama Islam
        </p>
        <p class="kalimatpembuka, container">Kampus ITS, ITS News — Institut Teknologi Sepuluh Nopember (ITS) kembali menggelar Mentoring Agama Islam Semester Genap 2024/2025 dengan berbagai rangkaian kegiatan. Kegiatan ini bertujuan membentuk karakter mahasiswa baru (maba) muslim berbasis nilai-nilai Islam. Acara yang resmi dibuka dalam kuliah umum ini berlangsung di Masjid Manarul Ilmi ITS, Sabtu (22/02).
        </p>
